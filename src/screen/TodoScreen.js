    ...
    <View style={{ marginBottom: 10 }}>
      <SwipeListView
        ...
        renderItem={(data, rowMap) => (
          <View style={{ backgroundColor: 'white', borderRadius: 4, width: '100%', justifyContent: 'center', padding: 5 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              ...
              <View style={{ flex: 1, paddingStart: 10 }}>
                ...
                <Text style={{ color: 'gray', fontSize: 12 }}>DUE DATE: {data.item.duedate}</Text>
                <Text style={{ color: 'gray', fontSize: 12 }}>DUE TIME: {data.item.duetime}</Text>
              </View>
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
